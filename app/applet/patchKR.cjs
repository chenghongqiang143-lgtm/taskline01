...
const newDiv = '<div key={t.id} className={`flex justify-between items-center group/task bg-gray-50 px-2.5 py-1.5 rounded-lg border shadow-sm ${t.important ? \'border-yellow-300 bg-yellow-50/50\' : \'border-gray-100\'}`}>';
